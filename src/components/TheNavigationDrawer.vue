...
<template>
    ...
    <div>
        <img
            ...
            height="100"
        />    
        <h3><a class="green" target="_blank" href="https://vitejs.dev/">.vite()</a></h3>
    </div>
    <div>
        <img
            alt="Vue logo"
    ...
    <div>
        ...
        <h3>
            <a target="_blank" href="https://pages.github.com">.gitHubPages()</a>
        </h3>
    </div>
</template>
