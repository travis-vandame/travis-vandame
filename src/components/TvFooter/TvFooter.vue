  ...
  <div class="tv-app-footer">
    <div class="vite">
      <tv-link to="http://www.vitejs.dev">
        <img alt="Vite logo" class="logo" src="@/assets/images/vite-logo.svg" />
      </tv-link>
    </div>
    <div class="vue">
      <tv-link to="http://vuejs.org/">
        <img alt="Vue logo" class="logo" src="@/assets/images/vue-logo.svg" />
      </tv-link>
    </div>
    <div class="mdn">
...
.tv-app-footer {
  ...
  background-color: v-bind('props.cssBackgroundColor');
