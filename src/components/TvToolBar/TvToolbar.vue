...
const emit = defineEmits<{
  (event: 'toolbarEvent', value: unknown): Record<string, unknown>
}>()
...
<template>
  <div class="tv-app-toolbar">
    ...
    <div class="tv-app-toolbar-icon-button-settings" @click="toggleMenu">
      <slot name="menu-icon"></slot>
    </div>
    <div
      class="tv-app-toolbar-icon-button-minimal"
      @click="toggleMinimal"
